// src/pages/admin/menu/AddCategory.jsx
import React, { useState } from 'react';
import { useNavigate, useLocation } from 'react-router-dom';
import { motion } from 'framer-motion';
import Swal from 'sweetalert2';
import toast from 'react-hot-toast';
import { Layers, ArrowLeft, Upload, X, Check } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.response?.data?.detail || 'An error occurred while saving the category.',
      });
    } finally {
      setLoading(false);
    }
        ...
        >
          ...
          <div className="menu-form-header">
            ...
            <div className="menu-form-title">
              ...
              <p>Add a food category to group related dishes and delicacies</p>
            </div>
          </div>
            ...
            <div className="menu-form-grid">
              ...
              <div className="menu-form-group">
                ...
                <input
                  ...
                  placeholder="e.g. Tandoori Roti, Afghani Special, Curries"
                  value={formData.name}
              ...
              <div className="menu-form-group">
                <label className="menu-form-label">Category Icon / Image (Optional)</label>
